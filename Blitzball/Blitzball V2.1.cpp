...
#include <vector>//free of logic errors, probably :p
using namespace std;
ofstream recap;
...
//========================GAME VARIABLES===============================
const int radius = 10000; //pool radius
const int ballspot_distance = 6000; //distance away from which player can see ball
const int engage_distance = 1000;//nuff said -- dukes up
int shtbonus = 0; //NOT SHIT BONUS
...
void team_pick(Team &team){
 ...
 if (temp2 == "#EOF#" or temp2 == "#EOF#|" or temp2 == "#EOF"){ 
  ...
  system("cls");//clears screen (PC Windows only)
  return; 
 }
 ...
 //Individual Players
 while(invalidTeam){
  system("cls");//clear console screen *pc only
  ++pos;
